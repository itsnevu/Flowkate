            ...
            <div className="flex justify-end">
              {confirmingClear ? (
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-soft bg-danger px-4 py-2 text-sm font-medium text-graphite-50 shadow-key transition-all duration-150 ease-press hover:bg-danger-hover active:translate-y-px active:bg-danger-active active:shadow-key-pressed">
